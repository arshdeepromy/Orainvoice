...
async def create_invoice_endpoint(
    ...
    try:
        result = await create_invoice(
            ...
            vehicle_wof_updated=payload.vehicle_wof_updated,
            vehicle_cof_updated=payload.vehicle_cof_updated,
            vehicle_service_due_updated=payload.vehicle_service_due_updated,
