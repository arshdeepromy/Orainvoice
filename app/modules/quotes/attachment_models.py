"""SQLAlchemy ORM model for quote attachments.

Tables:
- quote_attachments: file attachments linked to quotes (RLS enabled)
"""
...
class QuoteAttachment(Base):
    """File attachment linked to a quote.

    Stores metadata for images (JPEG, PNG, WebP, GIF) and PDFs attached
    to quotes. The actual file content is stored encrypted on disk
    ...
    uploaded_by_user = relationship(
        ...
        backref="uploaded_quote_attachments",
    )
