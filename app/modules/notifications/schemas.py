...
_DEFAULT_BODY_BLOCKS: dict[str, list[dict[str, Any]]] = {
    "invoice_issued": [
        ...
        {"type": "text", "content": "Your invoice is ready."},
        {"type": "button", "content": "View Invoice", "url": "{{payment_link}}"},
    ...
    "payment_received": [
        ...
        {"type": "text", "content": "A copy of your receipt is attached for your records."},
        {"type": "footer", "content": "Kind regards,\n{{org_name}}"},
    ],
    "payment_overdue_reminder": [
        {"type": "text", "content": "Hi {{customer_first_name}},"},
        {"type": "text", "content": "This is a friendly reminder that you have an outstanding invoice. Please arrange payment at your earliest convenience."},
        {"type": "text", "content": "You can view and pay online using the button below."},
        {"type": "button", "content": "View Invoice", "url": "{{payment_link}}"},
        {"type": "text", "content": "If you've already made this payment, please disregard this message."},
        {"type": "footer", "content": "Kind regards,\n{{org_name}}"},
    ],
    "invoice_voided": [
        {"type": "text", "content": "Hi {{customer_first_name}},"},
    ...
    "quote_sent": [
        {"type": "text", "content": "Hi {{customer_first_name}},"},
        {"type": "text", "content": "Your quote is ready for review. Please find it attached."},
        {"type": "text", "content": "This quote is valid until {{quote_valid_until}}. If you have any questions or would like to proceed, please get in touch."},
        {"type": "footer", "content": "Kind regards,\n{{org_name}}"},
    ],
    "quote_accepted": [
        {"type": "text", "content": "Hi {{customer_first_name}},"},
        {"type": "text", "content": "Thanks for accepting your quote. We'll be in touch shortly to arrange the work."},
        {"type": "footer", "content": "Kind regards,\n{{org_name}}"},
    ],
    "quote_expired": [
        {"type": "text", "content": "Hi {{customer_first_name}},"},
        {"type": "text", "content": "Your quote has expired. Contact us if you'd like a new one — we're happy to help."},
        {"type": "footer", "content": "Kind regards,\n{{org_name}}"},
    ],
    "user_invitation": [
