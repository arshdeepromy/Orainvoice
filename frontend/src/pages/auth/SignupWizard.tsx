  ...
  return (
    <div className="mx-auto max-w-lg py-12 px-4">
      ...
      <div className="overflow-hidden">
        ...
        >
          {/* Step 1: Signup Form */}
          <div className="w-full flex-shrink-0" aria-hidden={step !== 'form'}>
            {resetMessage && (
              <AlertBanner
                variant="warning"
          ...
          {/* Step 2: Payment */}
          <div className="w-full flex-shrink-0" aria-hidden={step !== 'payment'}>
            <div data-testid="payment-step">
              {step === 'payment' && signupResult?.stripe_client_secret && signupResult?.pending_signup_id && (
                <PaymentStep
          ...
          {/* Step 3: Confirmation */}
          <div className="w-full flex-shrink-0" aria-hidden={step !== 'done'}>
