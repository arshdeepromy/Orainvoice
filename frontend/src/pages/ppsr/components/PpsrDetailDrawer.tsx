...
export function PpsrDetailDrawer({
  ...
  return (
    ...
    >
      ...
      >
        <header className="sticky top-0 z-10 flex items-center justify-between gap-2 border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-gray-900">
          ...
          <div className="flex items-center gap-2">
            {isAdmin && (result || forgotten) && !forgotten && (
              <button
                ...
                className="inline-flex h-9 min-h-[36px] items-center rounded-md border border-red-300 bg-white px-3 text-xs font-medium text-red-700 shadow-sm hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-700 dark:bg-gray-800 dark:text-red-300 dark:hover:bg-red-900/20"
            ...
            <button
              ...
              className="rounded p-2 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:text-gray-200"
              ...
              <dl className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {forgotten.rego && (
                  <div>
                    ...
                    <dd className="mt-0.5 font-mono text-sm text-gray-800 dark:text-gray-200">
                      {forgotten.rego}
                    </dd>
                  </div>
                )}
