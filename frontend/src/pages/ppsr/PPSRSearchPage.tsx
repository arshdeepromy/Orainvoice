  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Progress bar */}
        <div
          className="h-2 w-full max-w-xs overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700"
          role="progressbar"
          aria-valuemin={0}
          aria-valuemax={100}
          aria-valuenow={pct}
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-[12rem_1fr]">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="h-10 min-h-[44px] w-full rounded-md border border-gray-300 px-3 py-2 font-mono text-base uppercase text-gray-900 shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
        ...
        >
          ...
          {/* Hidden-plate */}
          <label
            className="inline-flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300"
      ...
      {ownerSectionVisible && (
        <div className="mt-4 max-w-md">
          ...
          <input
            ...
            className="mt-1 h-10 min-h-[44px] w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
            required
          />
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        <button
          ...
          className="inline-flex h-10 min-h-[44px] items-center rounded-md bg-blue-600 px-5 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-blue-500 dark:hover:bg-blue-400"
  ...
  return (
    ...
    >
      ...
      {error && (
        <div
          role="alert"
          className="rounded-md border border-red-300 bg-red-50 p-3 text-sm text-red-900 dark:border-red-700 dark:bg-red-900/20 dark:text-red-100"
