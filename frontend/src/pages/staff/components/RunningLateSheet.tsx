...
export default function RunningLateSheet({
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg overflow-hidden rounded-t-xl bg-white shadow-xl dark:bg-gray-900 sm:rounded-xl">
        ...
        {success ? (
          <div className="px-6 py-8 text-center">
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-lg bg-blue-600 px-6 py-2 text-sm font-medium text-white hover:bg-blue-700"
