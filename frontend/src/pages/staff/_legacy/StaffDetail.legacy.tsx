 ...
 * gate per design §2). The new tabbed shell at `frontend/src/pages/staff/
 * StaffDetail.tsx` delegates to this file when the module is off so that
 * orgs without the new feature still see the original UX unchanged.
 *
