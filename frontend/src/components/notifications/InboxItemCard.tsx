...
/** Returns Tailwind classes for the severity icon container. */
...
export default function InboxItemCard({ item, onClick, onDismiss }: InboxItemCardProps) {
  ...
  return (
    <div
      ...
      className={`relative flex w-full items-start gap-3 px-4 py-3 text-left transition-colors cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 ${
      ...
      <div className="min-w-0 flex-1">
        ...
        {onDismiss && (
          <button
            ...
            className="mt-1 text-xs font-medium text-gray-400 hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400 transition-colors"
          >
            Dismiss
          </button>
        )}
