    ...
    >
      <div className="w-full max-w-md space-y-6 rounded-xl bg-white p-8 shadow-2xl">
        ...
        {availableMethods.length > 1 && (
          <div>
            <p className="mb-2 text-sm font-medium text-gray-700">Verification method</p>
          ...
          <div className="space-y-4 text-center">
            {passkeyLoading ? (
              <div className="py-8">
                ...
                <p className="mt-3 text-sm text-gray-600">Waiting for your passkey...</p>
              </div>
            ) : (
              <div className="py-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {method === 'backup' ? (
              <div className="flex flex-col gap-1">
                <label htmlFor="backup-code-modal" className="text-sm font-medium text-gray-700">
                  Backup code
                </label>
                <input
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">6-digit code</label>
