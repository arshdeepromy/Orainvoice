  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ backgroundColor: 'var(--content-bg)' }}>
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-h-0">
        {/* Header */}
        <header
          className="flex h-16 items-center gap-4 border-b border-border bg-card px-4"
          role="banner"
        >
          <button
            className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded-md text-muted hover:text-text lg:hidden"
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-accent-soft text-sm font-medium text-accent hover:brightness-95"
            ...
            {userMenuOpen && (
              <div 
                className="absolute right-0 mt-2 w-48 rounded-md bg-card shadow-pop ring-1 ring-border z-50"
                role="menu"
              ...
              >
                <div className="py-1">
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-4 py-2 text-sm text-text hover:bg-canvas min-h-[44px]"
                    role="menuitem"
                  >
                    <UserIcon />
                    Profile
