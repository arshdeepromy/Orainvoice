...
/**
 * CustomerCreateModal — Task 20 port of frontend/src/components/customers/CustomerCreateModal.
 *
 * The full new-customer dialog (tabs, address, contacts, kiosk mode, display-name
 * suggester) used by the invoice form's customer search. ALL logic — validation,
 * payload building, kiosk variant, branch assignment — is copied VERBATIM. Styling
 * stays on the neutral palette (available in v2); the full token restyle of the
 * Customers module is owned by Tasks 23/25, which will adopt this component.
 * v2 Button has no `secondary` variant, so `secondary` is mapped to `ghost`.
 */
