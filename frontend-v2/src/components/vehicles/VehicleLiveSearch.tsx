...
/**
 * VehicleLiveSearch — Task 20 port of frontend/src/components/vehicles/VehicleLiveSearch.
 *
 * All logic copied VERBATIM: debounced rego search against /vehicles/search,
 * Enter-to-select-first / Enter-to-CarJam-sync, /vehicles/lookup-with-fallback
 * onboarding, linked-customer auto-select, and the selected-vehicle summary
 * card. Styling stays on the same neutral palette (available in v2) so it reads
 * consistently inside the invoice form; the full token restyle is owned by
 * Task 25 (VehicleList/VehicleProfile + vehicle modals) which will adopt this.
 */
interface Vehicle {
  id: string
  rego: string
...
export default VehicleLiveSearch
