...
export function CardForm({ onSuccess, onCancel }: CardFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 rounded-card border border-border bg-card p-5">
      <h3 className="text-sm font-semibold text-text">Add a new card</h3>
