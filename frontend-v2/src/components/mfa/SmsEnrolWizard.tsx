  ...
  if (success) {
    return (
      <div className="space-y-4 text-center">
        ...
        <p className="text-sm font-medium text-text">SMS verification enabled</p>
        <p className="text-sm text-muted-2">Your account is now protected with SMS verification codes.</p>
        <button
          onClick={onComplete}
    ...
    <div className="space-y-4">
      ...
      {step === 'phone' && (
        <>
          ...
          <div>
            <label htmlFor="sms-phone" className="block text-sm font-medium text-text mb-1">
              Phone number
            </label>
            <input
              id="sms-phone"
              ...
              className="block w-full rounded-ctl border border-border bg-card px-3 py-2 text-sm text-text placeholder:text-muted-2 focus:border-accent focus:outline-none focus:shadow-[0_0_0_3px_var(--accent-soft)]"
      ...
      {step === 'verify' && (
        <>
          ...
          <div>
            <label htmlFor="sms-code" className="block text-sm font-medium text-text mb-1">
              Verification code
            </label>
            <input
              id="sms-code"
