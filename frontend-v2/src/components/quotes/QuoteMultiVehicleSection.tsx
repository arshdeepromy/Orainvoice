/**
 * QuoteMultiVehicleSection — Task 21 port of
 * frontend/src/components/quotes/QuoteMultiVehicleSection.tsx.
 *
 * Allows adding multiple vehicles to a quote. Gated on
 * isAutomotive && isEnabled('vehicles') in the parent. Logic copied VERBATIM
 * (add/remove/update, expand-on-first-vehicle). The inner inputs keep the
 * neutral gray styling (available in v2) so they sit alongside the rest of the
 * QuoteCreate form, matching the InvoiceCreate port (FR-2 / FR-2b).
 */
