/**
 * QuoteAttachmentList — Task 21 port of
 * frontend/src/components/quotes/QuoteAttachmentList.tsx.
 *
 * Displays attachments for a quote with download and delete. Mirrors the
 * invoice attachment list pattern. Logic copied VERBATIM (fetch with
 * AbortController, delete, file-size/icon helpers, draft-only delete).
 */
