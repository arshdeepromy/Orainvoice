/**
 * InventoryPickerModal — Task 21 port of
 * frontend/src/components/quotes/InventoryPickerModal.tsx.
 *
 * Lets the user select a stock item from inventory to add as a line item, with
 * a "Quick Add Stock" button that opens the AddToStockModal inline. Logic copied
 * VERBATIM (fetch with AbortController + active_only, search filter across
 * name/sku/category/brand, gst_inclusive normalisation on select). Uses the v2
 * Modal primitive and the already-ported AddToStockModal (FR-3 self-contained).
 */
