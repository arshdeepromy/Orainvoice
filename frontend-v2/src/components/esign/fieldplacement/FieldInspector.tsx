 ...
 *   - **Label + placeholder** (R5.2) — shown for `text` fields only, so the
 *     sender can label the input the recipient will fill in.
...
export interface FieldInspectorProps {
  ...
  /** Set a `text` field's label/placeholder (R5.2). */
