...
/**
 * CreditNoteModal — Task 19 port of frontend/src/components/invoices/CreditNoteModal.
 *
 * All logic (validation, item add/remove, submit → POST /invoices/:id/credit-note,
 * toast feedback, state reset on open) is copied VERBATIM. Styling is remapped
 * onto the design-system tokens (`.input`/`.textarea` language from ds.css) and
 * the v2 Button API (`secondary` → `ghost`). Shared with Task 22.
 */
      ...
      <Modal open={open} onClose={onClose} title="Create Credit Note">
        <div className="space-y-4">
          ...
          <div>
            ...
            {showMismatch && (
              <div className="mt-1 text-sm text-warn" role="alert">
