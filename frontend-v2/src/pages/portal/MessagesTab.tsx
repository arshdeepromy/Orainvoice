...
export function MessagesTab({ token }: MessagesTabProps) {
  ...
  if (messages.length === 0) {
    return <p className="py-8 text-center text-sm text-muted">No messages found.</p>
  }
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div className={`mt-1 flex items-center gap-2 text-xs text-muted-2 ${isOutbound ? 'justify-end' : ''}`}>
