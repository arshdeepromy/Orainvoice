...
function StatBar({
  ...
  return (
    <div className="flex items-center gap-2 text-xs">
      <span className="w-24 shrink-0 truncate text-text">
        {label}
      </span>
      <div className="relative h-2 flex-1 overflow-hidden rounded bg-border">
        <div
      ...
      <span className="w-10 shrink-0 text-right mono text-text">
...
function DeliveryStatsCard({
  ...
  return (
    <div className="rounded-card border border-border bg-card p-4 shadow-card">
      ...
      <p className="mt-1 text-2xl font-semibold text-text mono">
  ...
  return (
    <div className="overflow-x-auto rounded-card border border-border bg-card shadow-card">
      <table className="min-w-full">
        <thead>
          <tr>
            {[
              ...
              <th
                key={header}
                className="mono border-b border-border px-3 py-2 text-left text-[10.5px] font-medium uppercase tracking-[0.08em] text-muted-2"
              >
                {header}
              </th>
            ))}
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.id} className="border-b border-border last:border-b-0 text-sm text-text hover:bg-canvas">
