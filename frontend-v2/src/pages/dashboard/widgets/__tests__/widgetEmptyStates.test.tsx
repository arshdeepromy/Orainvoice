 ...
 *
 * Ported from frontend/src/pages/dashboard/widgets/__tests__/widgetEmptyStates.test.tsx
 * (Task 18). Verifies each widget's empty-state copy renders — the strings are
 * preserved verbatim from the original widgets (FR-1).
 *
