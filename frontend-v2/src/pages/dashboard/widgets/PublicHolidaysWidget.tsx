 ...
 *
 * Ported from frontend/src/pages/dashboard/widgets/PublicHolidaysWidget.tsx
 * (Task 18). Logic, inline icon and empty-state copy preserved verbatim (FR-1);
 * presentation remapped onto the redesign tokens (FR-2).
 *
...
export function PublicHolidaysWidget({ data, isLoading, error }: PublicHolidaysWidgetProps) {
  ...
  return (
    ...
    >
      {items.length === 0 ? (
        <p className="text-[13px] text-muted">No upcoming public holidays</p>
      ) : (
