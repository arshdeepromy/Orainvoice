 ...
 *
 * Ported verbatim from frontend/src/pages/dashboard/widgets/useDashboardWidgets.ts
 * (Task 18, FR-1). The endpoint (`GET /dashboard/widgets`), the AbortController +
 * CanceledError guard, and the `normaliseDashboardData` `?? []` / `?? 0` defaults
