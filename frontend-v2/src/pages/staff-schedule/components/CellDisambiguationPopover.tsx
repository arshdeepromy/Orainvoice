 ...
 * frontend/src/pages/staff-schedule/components/CellDisambiguationPopover.tsx;
...
export default function CellDisambiguationPopover({
  ...
  return (
    <div
      ...
      style={style}
      className="rounded-card border border-border bg-card shadow-pop p-1 min-w-[220px]"
    >
        ...
        {entries.map((e) => (
          <li key={e.id}>
            <button
              ...
              role="menuitem"
              onClick={() => onPick(e)}
              className="block w-full rounded-ctl px-3 py-2 text-left text-sm text-text hover:bg-accent-soft focus:bg-accent-soft focus:outline-none"
            >
