...
export function SecuritySettings() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <p className="text-sm text-muted-2">Loading security settings…</p>
      </div>
    )
  }
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-text mb-6">Security Settings</h1>
      <ToastContainer toasts={toasts} onDismiss={dismissToast} />

      <div className="space-y-2">
        <Collapsible label="🔐 MFA Enforcement" defaultOpen className="border border-border rounded-card">
        ...
        <Collapsible label="🔑 Password Policy" className="border border-border rounded-card">
        ...
        <Collapsible label="🚫 Account Lockout" className="border border-border rounded-card">
        ...
        <Collapsible label="👥 Roles & Permissions" className="border border-border rounded-card">
          <RolesPermissionsSection />
        </Collapsible>

        <Collapsible label="⏱ Session Management" className="border border-border rounded-card">
        ...
        <Collapsible label="📋 Audit Log" className="border border-border rounded-card">
