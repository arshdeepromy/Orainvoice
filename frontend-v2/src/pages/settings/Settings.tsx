  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 h-full">
      ...
      <nav
        ...
        className="md:w-56 flex-shrink-0 border-b md:border-b-0 md:border-r border-border md:sticky md:top-0 md:self-start"
      >
          ...
          {visibleNavItems.map((item) => (
            <li key={item.id}>
              <button
                ...
                className={`w-full flex items-center gap-2 rounded-ctl px-3 py-2 text-sm font-medium transition-colors whitespace-nowrap
                  ${active === item.id
