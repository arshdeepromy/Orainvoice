  ...
  return (
    ...
    >
      ...
      <section className="mb-4 flex flex-wrap items-end gap-3">
        <label className="block">
          ...
          <select
            ...
            className="mt-1 block min-h-[44px] min-w-[280px] rounded-ctl border border-border bg-card px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-accent disabled:opacity-50"
          >
            {(periods ?? []).length === 0 && (
      ...
      {periodsLoading || payslipsLoading ? (
        ...
        <div
          className="rounded-card border border-dashed border-border px-4 py-12 text-center text-sm text-muted-2"
            ...
            <tbody>
              {(payslips ?? []).map((p) => (
                ...
                >
                  ...
                  <td className="mono px-4 py-2 text-right text-text">
                  ...
                  <td className="px-4 py-2 text-right">
                    <button
                      ...
                      className="min-h-[36px] rounded-ctl border border-border px-3 py-1 text-xs font-medium text-muted hover:bg-canvas"
                    >
