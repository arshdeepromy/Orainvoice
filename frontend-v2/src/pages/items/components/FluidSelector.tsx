  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-medium text-text">Fluids</h4>
        <button
          type="button"
          onClick={handleAddFluid}
          className="min-h-[44px] inline-flex items-center gap-1 rounded-ctl bg-accent-soft px-3 py-2 text-sm font-medium text-accent hover:bg-accent-soft"
        >
