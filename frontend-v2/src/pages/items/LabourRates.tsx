          ...
          <table className="w-full border-collapse" role="grid">
            ...
            <thead>
              <tr>
                ...
                <th scope="col" className={TH_R}>Hourly Rate</th>
            ...
            <tbody>
              {rates.length === 0 ? (
                ...
                rates.map((rate) => (
                  <tr key={rate.id} className="border-b border-border last:border-b-0 hover:bg-canvas">
                    <td className="whitespace-nowrap px-4 py-3 text-sm font-medium text-text">{rate.name}</td>
                    <td className="mono whitespace-nowrap px-4 py-3 text-sm text-right font-medium text-text">
                      ${rate.hourly_rate}/hr
                    </td>
                    ...
                    <td className="whitespace-nowrap px-4 py-3 text-sm text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button size="sm" variant="ghost" onClick={() => openEdit(rate)}>Edit</Button>
