...
export default function RevenueSummary() {
  ...
  return (
    <div data-print-content>
      <p className="text-sm text-muted mb-4 no-print">Total revenue, GST collected, and monthly breakdown.</p>
        ...
        <>
          ...
          <div className="rounded-card border border-border bg-card p-4 shadow-card">
            ...
            {data.monthly_breakdown && data.monthly_breakdown.length > 0 ? (
              ...
              <p className="text-sm text-muted py-8 text-center">No monthly data available for this period.</p>
            )}
          </div>
        </>
      )}
