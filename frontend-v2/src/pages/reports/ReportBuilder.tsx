...
export default function ReportBuilder() {
  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8">
      <h1 className="text-2xl font-semibold text-text mb-6">Report Builder</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          <label htmlFor="location-filter" className="block text-sm font-medium text-text mb-1">
            Location
          </label>
          <input
            id="location-filter"
            ...
            className="w-full rounded-ctl border border-border bg-card px-3 py-2 text-sm text-text placeholder:text-muted-2 focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_var(--accent-soft)]"
          />
        </div>
