 ...
 * branches and every data-testid preserved verbatim.
 *
...
export default function RequestLeaveModal({
  ...
  return (
    ...
    >
      <div className="bg-card rounded-card shadow-pop w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
        ...
        >
          ...
          {isConfidential && (
            <div
              ...
              className="rounded-ctl bg-accent-soft border border-accent/30 px-3 py-2 text-xs text-accent"
            >
          ...
          {isBereavement && (
            <div className="rounded-ctl border border-warn/30 bg-warn-soft p-3 space-y-2">
              <div>
          ...
          {requiresNote && (
            <div>
              ...
              <input
                ...
                disabled={submitting}
                className="block w-full text-sm text-text file:mr-3 file:rounded-ctl file:border-0 file:bg-accent-soft file:px-3 file:py-2 file:text-sm file:font-medium file:text-accent hover:file:bg-accent-soft"
              />
              {form.doctorNoteFile && (
