...
export function InvoicePreview({ data }: InvoicePreviewProps) {
  ...
  return (
    <div
      className="border border-border rounded-card bg-card shadow-card overflow-hidden text-xs"
      role="img"
    ...
    >
      ...
      {/* Invoice details */}
      <div className="px-4 py-2 border-b border-border flex justify-between text-muted">
        <div>
          <p className="font-medium text-text">Bill To:</p>
          <p>Sample Customer</p>
      ...
      <div className="px-4 py-2 border-t border-border">
        <div className="flex justify-end">
          <div className="w-40 space-y-1">
            ...
            <div className="flex justify-between">
              <span className="text-muted">{data.taxLabel} ({data.taxRate}%):</span>
              <span>{formatCurrency(taxAmount)}</span>
            </div>
            <div
              className="flex justify-between font-bold text-sm pt-1 border-t border-border"
