...
// Preserved verbatim from the original SetupWizard, which declares this helper
// but never calls it. v2's stricter `noUnusedLocals` would reject an unused
// declaration, so this no-op reference keeps the helper present (drop nothing)
// without changing any runtime behaviour.
void backendStepToUi
...
export function SetupWizard() {
  ...
  if (loadingProgress) {
    return (
      <div className="bg-canvas flex items-center justify-center py-20">
    ...
    <div className="bg-canvas flex items-start justify-center px-4 py-12 sm:py-16">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-text">Set Up Your Business</h1>
