      ...
      <div className="w-full max-w-lg">
        <div className="bg-card rounded-card shadow-card border border-border p-6 sm:p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-bold text-text">Review Your Choices</h2>
                  ...
                  {(modules ?? []).map((mod) => {
                    ...
                    return (
                      ...
                      >
                        {enabled ? (
                          <span
                            className="text-ok font-bold text-base leading-none"
                            aria-hidden="true"
                          >
                            ✓
                          </span>
                          ...
                          <span
                            className="text-muted-2 font-bold text-base leading-none"
                            aria-hidden="true"
                          >
                            —
                          </span>
          ...
          {error && (
            <div
              className="flex items-start gap-2 rounded-card bg-danger-soft border border-danger/30 p-3"
              role="alert"
            >
              <svg
                className="h-5 w-5 text-danger mt-0.5 shrink-0"
