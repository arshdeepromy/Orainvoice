    ...
    return (
      <div className="bg-canvas flex items-start justify-center px-4 py-12 sm:py-16">
        <div className="w-full max-w-lg">
          <div className="bg-card rounded-card shadow-card border border-border p-6 sm:p-8 text-center space-y-4">
      ...
      <div className="bg-canvas flex items-start justify-center px-4 py-12 sm:py-16">
        <div className="w-full max-w-lg">
          <div className="bg-card rounded-card shadow-card border border-border p-6 sm:p-8 text-center space-y-6">
            <h1 className="text-2xl font-bold text-text">All Modules Enabled</h1>
            <p className="text-sm text-muted leading-relaxed">
              All available modules for your plan are already enabled. There's nothing to
              configure right now.
            </p>
            <Button variant="primary" size="md" onClick={() => navigate('/settings?tab=modules')}>
              Back to Settings
            </Button>
          </div>
        </div>
    ...
    return (
      <div className="bg-canvas flex items-start justify-center px-4 py-12 sm:py-16">
        <div className="w-full max-w-lg">
          <div className="bg-card rounded-card shadow-card border border-border p-6 sm:p-8 text-center space-y-6">
            <div
              className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-ok-soft"
              aria-hidden="true"
            >
              <svg
