      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="mb-4">
          <p className="text-sm text-muted">
            File: <span className="font-medium text-text">{doc.file_name}</span>
          </p>
        </div>

        {/* Category searchable dropdown */}
        <div className="relative mb-4" ref={dropdownRef}>
          <label htmlFor="edit-category" className="mb-1 block text-sm font-medium text-text">
        ...
        {/* Expiry date */}
        <div className="mb-4">
          <label htmlFor="edit-expiry" className="mb-1 block text-sm font-medium text-text">
            Expiry Date
          </label>
          <input
            id="edit-expiry"
