 ...
 *
 * Task 20 port — copied VERBATIM from frontend/src/utils/printerDrivers.ts so the
 * POS receipt printing path on InvoiceDetail behaves byte-identically. No visual
 * surface, so nothing to restyle.
 *
