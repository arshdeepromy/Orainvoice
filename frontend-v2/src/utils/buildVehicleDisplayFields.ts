 ...
 *
 * Ported VERBATIM from frontend/src/utils/buildVehicleDisplayFields.ts (Task 19).
 */
...
export function buildVehicleDisplayFields(
  ...
  fallback?: {
    ...
    vehicle?: { wof_expiry?: string | null; cof_expiry?: string | null; inspection_type?: string | null } | null
  },
): VehicleDisplayField[] {
