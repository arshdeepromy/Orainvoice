 ...
 *
 * Task 20 port — copied VERBATIM from frontend/src/utils/posReceiptPrinter.ts
 * (only the apiClient import is the v2 `@/api/client`). Orchestrates default
 * printer resolution, ESC/POS data generation, driver dispatch, fallback mode,
 * and error handling for InvoiceDetail's "POS Print" button.
 *
