 ...
 *
 * Ported VERBATIM from frontend/src/utils/escpos.ts (Task 19) — no logic
 * changes, this is a pure command/type module shared by the invoice POS
 * receipt preview + mapper.
 */
