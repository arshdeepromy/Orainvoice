...
/**
 * useModuleGuard — Task 26 port of frontend/src/hooks/useModuleGuard.ts.
 * Logic copied VERBATIM: checks whether a module is enabled via ModuleContext,
 * and if disabled (after context load), redirects to /dashboard with a warning
 * toast. Returns the toast queue so the consuming page can render the
 * ToastContainer for the redirect message.
 */
