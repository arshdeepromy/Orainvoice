...
/**
 * Configuration for a single item in the More menu.
 */
export interface MoreMenuItem {
  ...
  route: string
  /** Module slug required. Use '*' for always visible. */
  moduleSlug: string
  /** Trade family gate. Undefined = all trade families. */
  tradeFamily?: string
  /** Role restriction. Undefined = all roles. */
  roles?: UserRole[]
}

/**
 * All More menu items with their module/trade-family/role gates.
 */
...
/**
 * MoreMenuScreen — grid of module-gated navigation items for all features
 * beyond the 4 main tabs (Dashboard, Invoices, Customers, Jobs).
 *
 * Each item is wrapped in ModuleGate so it only appears when the required
 * module is enabled, trade family matches, and user role is allowed.
 *
