...
def upgrade() -> None:
    ...
    # Drop and recreate with the new schema (JSONB line_items, auto_issue, etc.)
    op.execute("ALTER TABLE IF EXISTS recurring_schedules DISABLE ROW LEVEL SECURITY")
    op.execute("DROP TABLE IF EXISTS recurring_schedules CASCADE")
