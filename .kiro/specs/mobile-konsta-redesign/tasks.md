...
- [x] 1. Phase 1 — Infrastructure Setup
  - [x] 1.1 Install Konsta UI v5 and configure Tailwind CSS 4
  ...
  - [x] 1.2 Wrap App root with KonstaApp component
  ...
  - [x] 1.4 Create useGeolocation hook
  ...
  - [x] 1.5 Create StatusBadge component
  ...
  - [x] 1.6 Create HapticButton component
...
- [x] 3. Phase 2 — Navigation Shell
  - [x] 3.1 Create KonstaShell layout component
  ...
  - [x] 3.2 Create KonstaTabbar bottom tab bar
  ...
  - [x] 3.3 Create KonstaNavbar screen header
  ...
  - [x] 3.4 Create MoreDrawer sheet component
  ...
  - [x] 3.5 Create KonstaFAB floating action button
  ...
  - [x] 3.6 Create BranchPickerSheet component
  ...
  - [x] 3.7 Wire KonstaShell into App.tsx and update routing
  ...
  - [x] 3.8 Write unit tests for KonstaTabbar and MoreDrawer
...
- [x] 5. Phase 3 — Auth Screens
  - [x] 5.1 Redesign Login screen with Konsta UI
  ...
  - [x] 5.2 Redesign MFA Verification screen
  ...
  - [x] 5.4 Redesign Password Reset and Email Verification screens
  ...
  - [x] 5.5 Redesign Landing Page (mobile-optimized)
  ...
  - [x] 5.6 Redesign Public Invoice Payment page
...
- [x] 7. Phase 4 — Core Screens (Dashboard, Invoices, Customers)
  - [x] 7.1 Redesign Dashboard screen
  ...
  - [x] 7.2 Redesign Invoice List screen
  ...
  - [x] 7.3 Redesign Invoice Detail screen
  ...
  - [x] 7.4 Redesign Invoice Create/Edit screen
  ...
  - [x] 7.5 Redesign Customer List screen
  ...
  - [x] 7.6 Redesign Customer Create screen
  ...
  - [x] 7.7 Redesign Customer Profile screen
  ...
  - [x] 7.8 Write unit tests for Dashboard, Invoice List, and Customer List screens
...
- [x] 9. Phase 5 — Module Screens Batch 1 (Quotes, Job Cards, Vehicles, Bookings)
  - [x] 9.1 Redesign Quote List screen
  ...
  - [x] 9.2 Redesign Quote Create screen
  ...
  - [x] 9.3 Redesign Quote Detail screen
  ...
  - [x] 9.4 Redesign Job Card List screen
  ...
  - [x] 9.5 Redesign Job Card Create screen
  ...
  - [x] 9.6 Redesign Job Card Detail screen
  ...
  - [x] 9.7 Redesign Active Jobs Board (timer screen)
  ...
  - [x] 9.8 Redesign Vehicle List screen
  ...
  - [x] 9.9 Redesign Vehicle Profile screen
  ...
  - [x] 9.10 Redesign Booking Calendar screen
  ...
  - [x] 9.11 Write unit tests for Quote, Job Card, Vehicle, and Booking screens
...
- [x] 11. Phase 6 — Module Screens Batch 2 (Inventory, Catalogue, Staff, Projects)
  - [x] 11.1 Redesign Inventory screen
  ...
  - [x] 11.2 Redesign Catalogue Items screen
  ...
  - [x] 11.4 Redesign Projects screen
  ...
  - [x] 11.5 Write unit tests for Inventory, Catalogue, Staff, and Projects screens
    - Smoke test each screen renders with mocked data
    - Test module gating hides screens when module disabled
...
- [x] 13. Phase 7 — Module Screens Batch 3 (Expenses, Time Tracking, Schedule, POS)
  - [x] 13.1 Redesign Expenses screen
  ...
  - [x] 13.2 Redesign Time Tracking screen
  ...
  - [x] 13.3 Redesign Schedule screen
  ...
  - [x] 13.5 Write unit tests for Expenses, Time Tracking, Schedule, and POS screens
    - Smoke test each screen renders with mocked data
    - Test module gating hides screens when module disabled
    - Test camera integration falls back to file input on web
    - _Requirements: 35.1, 36.1, 37.1, 38.1, 55.1_

- [x] 14. Phase 7 Checkpoint
  - Ensure all module screens batch 3 render correctly
  - Ensure all tests pass and build succeeds
  - Ask the user if questions arise.

- [x] 15. Phase 8 — Module Screens Batch 4 (Recurring, Purchase Orders, Construction, Hospitality)
  - [x] 15.1 Redesign Recurring Invoices screen
  ...
  - [x] 15.2 Redesign Purchase Orders screen
  ...
  - [x] 15.3 Redesign Construction screens (Progress Claims, Variations, Retentions)
  ...
  - [x] 15.4 Redesign Hospitality screens (Floor Plan, Kitchen Display)
...
- [x] 17. Phase 9 — Module Screens Batch 5 (Assets, Compliance, SMS, Reports, Notifications)
  - [x] 17.1 Redesign Assets screen
  ...
  - [x] 17.2 Redesign Compliance Documents screen
  ...
  - [x] 17.3 Redesign SMS Chat screen
  ...
  - [x] 17.4 Redesign Reports screen
  ...
  - [x] 17.5 Redesign Notifications screen
  ...
  - [x] 17.6 Write unit tests for Assets, Compliance, SMS, Reports, and Notifications screens
    - Smoke test each screen renders with mocked data
    - Test compliance expiry pill colours
    - Test module gating
    - _Requirements: 43.1, 44.1, 45.1, 46.1, 47.1, 55.1_

- [x] 18. Phase 9 Checkpoint
  - Ensure all module screens batch 5 render correctly
  - Ensure all tests pass and build succeeds
  - Ask the user if questions arise.


- [x] 19. Phase 10 — Module Screens Batch 6 (Portal, Kiosk)
  - [x] 19.1 Redesign Customer Portal screen
  ...
  - [x] 19.3 Write unit tests for Portal and Kiosk screens
    - Smoke test each screen renders with mocked data
    - Test kiosk role hides standard tabs
    - _Requirements: 48.1, 49.1, 49.2_

- [x] 20. Phase 10 Checkpoint
  - Ensure Portal and Kiosk screens render correctly
  - Ensure all tests pass and build succeeds
  - Ask the user if questions arise.

- [x] 21. Phase 11 — Native Capacitor Plugins
  - [x] 21.1 Install missing Capacitor plugin dependencies
  ...
  - [x] 21.2 Wire Camera plugin into attachment screens
  ...
  - [x] 21.3 Wire Geolocation plugin into job timer
  ...
  - [x] 21.4 Wire Push Notifications plugin
  ...
  - [x] 21.6 Configure Status Bar and Splash Screen
  ...
  - [x] 21.7 Update native platform permissions
  ...
  - [x] 21.8 Write unit tests for native plugin hooks
...
- [x] 23. Phase 12 — Property-Based Tests
  - [x] 23.1 Write property test for tab bar resolution (Property 1)
  ...
  - [x] 23.2 Write property test for navigation item filtering (Property 2)
  ...
  - [x] 23.3 Write property test for invoice calculation correctness (Property 3)
  ...
  - [x] 23.4 Write property test for job card sorting invariant (Property 4)
  ...
  - [x] 23.5 Write property test for currency formatting (Property 5)
  ...
  - [x] 23.6 Write property test for status colour mapping completeness (Property 6)
...
- [x] 24. Phase 12 Checkpoint
  - Ensure all property-based tests pass
  - Ensure all unit tests pass
  - Ask the user if questions arise.

- [x] 25. Phase 13 — Build Verification and Acceptance
  - [x] 25.1 Verify theme system and brand colour propagation
  ...
  - [x] 25.2 Verify module gating preservation
  ...
  - [x] 25.3 Verify business logic preservation
  ...
  - [x] 25.4 Verify exclusions are respected
  ...
  - [x] 25.5 Verify touch targets and accessibility
  ...
  - [x] 25.6 Final build and test verification
