#!/usr/bin/env python3
"""Generate the design.md file for orainvoice-universal-platform spec."""
import os

SPEC_DIR = os.path.join(".kiro", "specs", "orainvoice-universal-platform")
OUTPUT = os.path.join(SPEC_DIR, "design.md")
...
# ── ORGANISATIONS EXTENSION + SETUP WIZARD ──
s("""#### organisations table extensions (ALTER TABLE)
```sql
...
# ── JOB, QUOTE, TIME TRACKING, PROJECT, EXPENSE TABLES ──
s("""### Job Module Tables
...
# ── PO, STAFF, SCHEDULING, BOOKING, POS TABLES ──
s("""### Purchase Order Tables
...
# ── HOSPITALITY, CONSTRUCTION, ECOMMERCE, FRANCHISE, LOYALTY TABLES ──
s("""### Hospitality Module Tables
...
# ── MODULE SYSTEM + FEATURE FLAGS + MIDDLEWARE ──
s("""## Core Service Designs
...
# ── CROSS-MODULE TRANSACTION, OFFLINE SYNC, RBAC ──
s("""### Cross-Module Transaction Pattern
...
# ── BACKGROUND TASKS, MIGRATION, SECURITY ──
s("""## Background Task Architecture
...
# ── FILE STRUCTURE, TESTING, CORRECTNESS PROPERTIES ──
s("""## Project File Structure (New Additions)
